    ...
    {   
         if (check_for_button_input() == 1)
         {
             ...
             if (found >= Prev && found <= EQ)
             {
                ...
                else if (found == Next) Go_Next_Field();                 // check if 'Next', Go_Next_Field();       
                else if (found == Play_Pause) Do_Save_New_Time();        // add code here to check if 'Play/Pause' then use Do_Save_New_Time();                
                else if (found == Minus) Decrease_Time();             // add code here to check if 'Minus' then use Decrease_Time();
                else if (found == Plus) Increase_Time();              // add code here to check if 'Plus' then use Increase_Time();
                else if (found == EQ) Exit_Time_Setup();                 // add code here to check if 'EQ' Exit_Time_Setup();
                found = 0xff;
             }
             else
             {
